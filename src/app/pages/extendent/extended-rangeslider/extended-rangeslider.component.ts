...
@Component({
  selector: 'app-extended-rangeslider',
  standalone: true,
  imports: [PageTitleComponent,NgxSliderModule],
  templateUrl: './extended-rangeslider.component.html',
  styleUrl: './extended-rangeslider.component.scss'
})
export class ExtendedRangesliderComponent {
// bread crum items
